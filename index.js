          ...
          return discard1(guard2(has_name(v.value0)(opt.value0)))(function() {
            return discard1(guard2(is_short(v.value0) || isNothing(v.value1)))(function() {
              return new Just(bind32(get2)(function(args2) {
                ...
                return discard22(put2(maybe(args2)(function() {
                  var $347 = flip(Cons.create)(args2);
                  return function($348) {
        ...
        return discard22(when3(isArg(un5(Option)(opt).optMain))(cut2))(function() {
          ...
          if (v instanceof CmdReader) {
            ...
            if (v1.value0 instanceof Just && v1.value1 instanceof NoBacktrack) {
              return lift24(bind32(applyFirst2(get2)(put2(Nil.value)))(function(args2) {
                return map110(pure6)(lift33(applyFirst1(applySecond2(enterContext2(arg)(v1.value0.value0))(runParserInfo(dictMonadP)(v1.value0.value0)(args2)))(exitContext2)));
              }));
            }
            ;
            if (v1.value0 instanceof Just && v1.value1 instanceof Backtrack) {
              return map27(pure6)(lift24(StateT(function(args2) {
                return applyFirst1(applySecond2(enterContext2(arg)(v1.value0.value0))(runParser(dictMonadP)(un5(ParserInfo)(v1.value0.value0).infoPolicy)(CmdStart.value)(un5(ParserInfo)(v1.value0.value0).infoParser)(args2)))(exitContext2);
              })));
            }
            ;
  ...
  return function(policy) {
    return function(p) {
      return function(args2) {
        return bind32(runParser(dictMonadP)(policy)(CmdStart.value)(p)(args2))(function(v) {
          if (v.value1 instanceof Nil) {
...
var runParser = function(dictMonadP) {
  ...
  return function(policy) {
    return function(isCmdStart) {
      return function(p) {
        return function(args2) {
          var result = apply5(map11(Tuple.create)(evalParser(p)))(pure13(args2));
          ...
          if (args2 instanceof Nil) {
            return exitP2(isCmdStart)(policy)(p)(result);
          }
          ;
          if (args2 instanceof Cons && (args2.value0 === "--" && notEq1(policy)(AllPositionals.value))) {
            return runParser(dictMonadP)(AllPositionals.value)(CmdCont.value)(p)(args2.value1);
          }
          ;
          if (args2 instanceof Cons) {
            return bind32(getPrefs2)(function(prefs2) {
              return bind32(do_step(prefs2)(args2.value0)(args2.value1))(function(v) {
                if (v.value0 instanceof Nothing) {
                  return hoistMaybe2(unexpectedError(args2.value0)(p))(result);
                }
                ;
                if (v.value0 instanceof Just) {
                  return runParser(dictMonadP)(newPolicy(args2.value0))(CmdCont.value)(v.value0.value0)(v.value1);
                }
                ;
          ...
          ;
          throw new Error("Failed pattern match at Options.Applicative.Common (line 186, column 38 - line 194, column 60): " + [args2.constructor.name]);
        };
      };
    };
  };
...
var getProgName = /* @__PURE__ */ mapFlipped3(argv)(function(args2) {
  return fromMaybe("")(bind11(index(args2)(1))(function(executablePath) {
...
var execParserPure = function(pprefs) {
  return function(pinfo) {
    return function(args2) {
      ...
      var p = runParserInfo3(pinfo$prime)(fromFoldable8(args2));
      var v = runP(p)(pprefs);
...
var argsToChars = function(args1) {
  return map20(function(v) {
    return v.value0;
  })(zip(["a", "b", "c", "d", "e", "f", "g", "h", "i", "j"])(map20(toLower)(args1)));
};
...
var args = /* @__PURE__ */ apply(parserApply)(/* @__PURE__ */ map(parserFunctor)(function(v) {
  return function(v1) {
    return new Args({
      path: v,
      output: v1
...
var main = function __do() {
  var v = execParser(info2(apApplyFlipped(parserApply)(args)(helper))(mempty(infoModMonoid)))();
